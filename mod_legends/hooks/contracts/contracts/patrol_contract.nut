::mods_hookExactClass("contracts/contracts/patrol_contract", function(o)
{
	...
	o.addKillCount = function ( _actor, _killer )
	{
		...
		if (_actor.getType() == this.Const.EntityType.GoblinWolfrider || _actor.getType() == this.Const.EntityType.KoboldWolfrider || _actor.getType() == this.Const.EntityType.Wardog || _actor.getType() == this.Const.EntityType.Warhound || _actor.getType() == this.Const.EntityType.SpiderEggs || _actor.getFlags().has("tail"))
		{
			return;
		}
